      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: VotingWidget.routeName,
              path: VotingWidget.routePath,
              requireAuth: true,
              asyncParams: {
                'pricecheck': getDoc(['prices'], PricesRecord.fromSnapshot),
                'artistdoc':
                    getDocList(['ARTISTS'], ArtistsRecord.fromSnapshot),
              },
              builder: (context, params) => VotingWidget(
                pricecheck: params.getParam(
                  'pricecheck',
                  ParamType.Document,
                ),
                artistdoc: params.getParam<ArtistsRecord>(
                  'artistdoc',
                  ParamType.Document,
                  isList: true,
                ),
            ...
            FFRoute(
              ...
              asyncParams: {
                'artistdoc':
                    getDocList(['ARTISTS'], ArtistsRecord.fromSnapshot),
                'artistdetails':
                    getDoc(['ARTISTS'], ArtistsRecord.fromSnapshot),
              },
            ...
            FFRoute(
              name: TermsPoliciesWidget.routeName,
              path: TermsPoliciesWidget.routePath,
              builder: (context, params) => TermsPoliciesWidget(),
            ),
            FFRoute(
              ...
              requireAuth: true,
              asyncParams: {
                'albumref': getDoc(['Albums'], AlbumsRecord.fromSnapshot),
                'tracklistRef':
                    getDocList(['ARTISTS'], ArtistsRecord.fromSnapshot),
              },
              builder: (context, params) => AlbumWidget(
                ...
                tracklistRef: params.getParam<ArtistsRecord>(
                  'tracklistRef',
                  ParamType.Document,
                  isList: true,
                ),
