...
import 'schema/free_votes_record.dart';
...
export 'schema/free_votes_record.dart';
...
Future<int> queryVouchersRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VouchersRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
/// Functions to query FreeVotesRecords (as a Stream and as a Future).
Future<int> queryFreeVotesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FreeVotesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FreeVotesRecord>> queryFreeVotesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FreeVotesRecord.collection,
      FreeVotesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FreeVotesRecord>> queryFreeVotesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
