...
import 'comment_tab_model.dart';
export 'comment_tab_model.dart';
...
class _CommentTabWidgetState extends State<CommentTabWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommentTabModel());
          ...
          children: [
            Flexible(
              child: AuthUserStreamWidget(
                builder: (context) => StreamBuilder<List<CommentsRecord>>(
                  stream: queryCommentsRecord(
                    queryBuilder: (commentsRecord) => commentsRecord
                        .where(
                          'comment_song',
                          isEqualTo: widget!.details,
                        )
                        .whereNotIn('comment_by',
                        ...
                        children: [
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                final comment =
                                    containerCommentsRecordList.toList();
                                if (comment.isEmpty) {
                                  return Center(
                                    child: Image.asset(
